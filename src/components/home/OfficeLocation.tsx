        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <ScrollReveal direction="left">
            <div className="rounded-xl overflow-hidden shadow-2xl transform hover:scale-[1.01] transition-transform">
              ...
              />
              <div className="bg-brand-blue py-4 px-6 flex items-center justify-between">
          ...
          <ScrollReveal direction="right" delay={0.2}>
            <div className="space-y-6 lg:pl-10">
              <h2 className="text-4xl font-bold text-text-dark">Besuchen Sie uns in Oensingen</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="flex-shrink-0 h-8 w-8 rounded-full bg-brand-blue flex items-center justify-center mt-1">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-text-dark">Zentrale Lage</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-text-dark">Vereinbaren Sie einen Termin</h3>
              ...
              >
                <a 
                  href="/contact" 
                  className="inline-block mt-6 px-8 py-3 bg-brand-blue text-white rounded-lg font-medium hover:opacity-90 transition-opacity"
                >
                  Kontakt aufnehmen
                </a>
              </motion.div>
